...
# sys.path.append('/content/drive/MyDrive/PROJECT/201_HaMaruki/201_32_Layout_parser/layout-model-training-master/layout-model-training-master/utils')

print(">>>>>>> convert_prima_to_coco >>>>>>")
